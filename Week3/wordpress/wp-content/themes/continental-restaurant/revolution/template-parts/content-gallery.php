...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="card-item card-blog-post">
		<?php
		    ...
		    $continental_restaurant_gallery_shortcode = get_post_gallery();

			if (!is_singular() && !empty($continental_restaurant_gallery_shortcode)) {
				if (!empty($continental_restaurant_gallery_shortcode)) {
					// Display the gallery
					echo '<div class="embedded-gallery">' . do_shortcode($continental_restaurant_gallery_shortcode) . '</div>';
				}
			}
		?>
