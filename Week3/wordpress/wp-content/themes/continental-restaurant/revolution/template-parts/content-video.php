		...
		<?php
			...
			if (!is_singular() && !empty($continental_restaurant_embeds)) {
			    ...
			    foreach ($continental_restaurant_embeds as $continental_restaurant_embed) {
			        ...
			        if (strpos($continental_restaurant_embed, 'video') !== false || strpos($continental_restaurant_embed, 'youtube') !== false || strpos($continental_restaurant_embed, 'vimeo') !== false || strpos($continental_restaurant_embed, 'dailymotion') !== false || strpos($continental_restaurant_embed, 'vine') !== false || strpos($continental_restaurant_embed, 'wordPress.tv') !== false || strpos($continental_restaurant_embed, 'hulu') !== false) {
			            ?>
